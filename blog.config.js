...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '🏆跨境电商5年+ 工厂、独立站、互联网项目', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiangnanxiaohe.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '创业项目, 记录生活,分享资源,教程,博客', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备202498980号', // 备案号 粤ICP备202498980号
...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20249980号', // 备案号 萌ICP备20249980号
  ...
  COMMENT_VALINE_CDN:
    process.env.NEXT_PUBLIC_VALINE_CDN ||
    'https://cdn.jsdmirror.cn/npm/valine@1.5.1/dist/Valine.min.js',
  COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || '', // Valine @see https://valine.js.org/quickstart.html 或 https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key
  COMMENT_VALINE_APP_KEY: process.env.NEXT_PUBLIC_VALINE_KEY || '',
  COMMENT_VALINE_SERVER_URLS: process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || '', // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
  COMMENT_VALINE_PLACEHOLDER:
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://cdn.jsdmirror.cn/gh/88lin/PicX@master/favicon.jiupf2ws8pc.ico', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
