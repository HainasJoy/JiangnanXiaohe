...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://jiangnanxiaohe.com
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '江南小和', // 您的昵称 例如 江南小和
  BIO: process.env.NEXT_PUBLIC_BIO || '海内存知己科技/创客联盟创始人-喜哥🏅', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiangnanxiaohe.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '创业指南,江南小和,日常博客,热点科技,创业经验,跨境电商,工厂,独立站,互联网项目,创客联盟,创客空间，创业', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@jiangnanxiaohe.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京公网安备11000002000201号 京ICP证0352173号 互联网新闻信息服务许可证 1150180608 网络文化经营许可证：京网文〔2024〕1035-089号信息网络传播视听节目许可证 05869516', // 备案号 闽ICP备XXXXXXX
