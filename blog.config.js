...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '创业项目, 博客', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/ https://music.163.com/song/media/outer/url?id=731419.mp3
    {
      name: '风を共に舞う気持ち',
